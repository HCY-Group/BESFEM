...
int main(int argc, char *argv[]) {
    ...
    bool half_is_anode = (cfg.half_electrode == sim::Electrode::ANODE);
        ...
        C2_out = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        C3_out = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        ...
        electrolyte_concentration->SetupField(*CnE_gf, Constants::init_CnE, *domain_parameters.pse, domain_parameters.gtPse);
        ...
        if (cfg.mode == sim::CellMode::HALF) // HALF-CELL
        {
            if(cfg.half_electrode == sim::Electrode::ANODE) {
                ...
                cathode_concentration->SetupField(*CnC_gf, Constants::init_CnC, *domain_parameters.psi, domain_parameters.gtPsi);

                cathode_concentration_1 = std::make_unique<CnC>(geometry, domain_parameters);
                cathode_concentration_2 = std::make_unique<CnC>(geometry, domain_parameters);
                cathode_concentration_3 = std::make_unique<CnC>(geometry, domain_parameters);

                CnC_gf_1 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
                CnC_gf_2 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
                CnC_gf_3 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());

                cathode_concentration_1->SetupField(*CnC_gf_1, 0.15, *domain_parameters.ps1, domain_parameters.gtPsi1);
                cathode_concentration_2->SetupField(*CnC_gf_2, 0.20, *domain_parameters.ps2, domain_parameters.gtPsi2);
                cathode_concentration_3->SetupField(*CnC_gf_3, 0.10, *domain_parameters.ps3, domain_parameters.gtPsi3);
        ...
        std::unique_ptr<mfem::ParGridFunction> Rxn_gf_1;
        std::unique_ptr<mfem::ParGridFunction> Rxn_gf_2;
        std::unique_ptr<mfem::ParGridFunction> Rxn_gf_3;

        std::unique_ptr<mfem::ParGridFunction> Rx_src_1;
        std::unique_ptr<mfem::ParGridFunction> Rx_src_2;
        std::unique_ptr<mfem::ParGridFunction> Rx_src_3;

        std::unique_ptr<mfem::ParGridFunction> mu_1_12;
        std::unique_ptr<mfem::ParGridFunction> mu_2_12;
        std::unique_ptr<mfem::ParGridFunction> mu_2_23;
        std::unique_ptr<mfem::ParGridFunction> mu_3_23;
        std::unique_ptr<mfem::ParGridFunction> mu_3_31;
        std::unique_ptr<mfem::ParGridFunction> mu_1_31;


        std::unique_ptr<mfem::ParGridFunction> sum_1_2;
        std::unique_ptr<mfem::ParGridFunction> sum_2_3;
        std::unique_ptr<mfem::ParGridFunction> sum_3_1;

        sum_1_2 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        sum_2_3 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        sum_3_1 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());


        // std::unique_ptr<mfem::ParGridFunction> RxC_gf, RxA_gf;
        std::unique_ptr<Reaction> reaction;
        std::unique_ptr<Reaction> reaction1;
        std::unique_ptr<Reaction> reaction2;
        std::unique_ptr<Reaction> reaction3;

        reaction = std::make_unique<Reaction>(geometry, domain_parameters);
        reaction1 = std::make_unique<Reaction>(geometry, domain_parameters);
        reaction2 = std::make_unique<Reaction>(geometry, domain_parameters);
        reaction3 = std::make_unique<Reaction>(geometry, domain_parameters);

        Rxn_gf = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        Rxn_gf_1 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        Rxn_gf_2 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        Rxn_gf_3 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());

        Rx_src_1 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        Rx_src_2 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        Rx_src_3 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());

        mu_1_12 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        mu_2_12 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());

        mu_2_23 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        mu_3_23 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());

        mu_3_31 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());
        mu_1_31 = std::make_unique<mfem::ParGridFunction>(geometry.parfespace.get());


        reaction->Initialize(*Rxn_gf, Constants::init_Rxn);
        reaction1->Initialize(*Rxn_gf_1, Constants::init_Rxn);
        reaction2->Initialize(*Rxn_gf_2, Constants::init_Rxn);
        reaction3->Initialize(*Rxn_gf_3, Constants::init_Rxn);
        ...
        double global_current_A = 0.0;
        double global_current_C = 0.0;
        double global_current_1 = 0.0;
        double global_current_2 = 0.0;
        double global_current_3 = 0.0;
        double VCell = 0.0;
            ...
            // while (VCell > 2.5){
                ...
                if (cfg.half_electrode == sim::Electrode::ANODE) {
                    ...
                    for (int vi = 0; vi < geometry.nV; vi++) {
                        if ( (*domain_parameters.AvP_1_2)(vi) > 1000.0 ){ // Check for interface presence
                            (*mu_1_12)(vi) = -Constants::Frd * ((1.095 * (*CnC_gf_1)(vi) * (*CnC_gf_1)(vi)) - (8.234 * (1.0e-7) * exp(14.31 * (*CnC_gf_1)(vi))) + (4.692 * exp(-0.5389 * (*CnC_gf_1)(vi))));
                            (*mu_2_12)(vi) = -Constants::Frd * ((1.095 * (*CnC_gf_2)(vi) * (*CnC_gf_2)(vi)) - (8.234 * (1.0e-7) * exp(14.31 * (*CnC_gf_2)(vi))) + (4.692 * exp(-0.5389 * (*CnC_gf_2)(vi))));
                        }
                    }

                    for (int vi = 0; vi < geometry.nV; vi++) {
                        if ( (*domain_parameters.AvP_2_3)(vi) > 1000.0 ){ // Check for interface presence
                            (*mu_2_23)(vi) = -Constants::Frd * ((1.095 * (*CnC_gf_2)(vi) * (*CnC_gf_2)(vi)) - (8.234 * (1.0e-7) * exp(14.31 * (*CnC_gf_2)(vi))) + (4.692 * exp(-0.5389 * (*CnC_gf_2)(vi))));
                            (*mu_3_23)(vi) = -Constants::Frd * ((1.095 * (*CnC_gf_3)(vi) * (*CnC_gf_3)(vi)) - (8.234 * (1.0e-7) * exp(14.31 * (*CnC_gf_3)(vi))) + (4.692 * exp(-0.5389 * (*CnC_gf_3)(vi))));
                        }
                    }

                    for (int vi = 0; vi < geometry.nV; vi++) {
                        if ( (*domain_parameters.AvP_3_1)(vi) > 1000.0 ){ // Check for interface presence
                            (*mu_3_31)(vi) = -Constants::Frd * ((1.095 * (*CnC_gf_3)(vi) * (*CnC_gf_3)(vi)) - (8.234 * (1.0e-7) * exp(14.31 * (*CnC_gf_3)(vi))) + (4.692 * exp(-0.5389 * (*CnC_gf_3)(vi))));
                            (*mu_1_31)(vi) = -Constants::Frd * ((1.095 * (*CnC_gf_1)(vi) * (*CnC_gf_1)(vi)) - (8.234 * (1.0e-7) * exp(14.31 * (*CnC_gf_1)(vi))) + (4.692 * exp(-0.5389 * (*CnC_gf_1)(vi))));
                        }
                    }
                    ...
                    *Rx_src_3 = *Rxn_gf_3;
                    ...
                    cathode_concentration_1->UpdateConcentration(*Rx_src_1, *CnC_gf_1, *domain_parameters.ps1, domain_parameters.gtPsi1, *domain_parameters.Weight_E_1,
                                                                *sum_1_2, *domain_parameters.Weight_1_2, *domain_parameters.AvP_1_2,
                                                                *sum_3_1, *domain_parameters.Weight_3_1, *domain_parameters.AvP_3_1,
                                                                *mu_1_12, *mu_2_12, *mu_1_31, *mu_3_31, *domain_parameters.ps1, *domain_parameters.ps2, *domain_parameters.ps3);
                    cathode_concentration_2->UpdateConcentration(*Rx_src_2, *CnC_gf_2, *domain_parameters.ps2, domain_parameters.gtPsi2, *domain_parameters.Weight_E_2,
                                                                *sum_1_2, *domain_parameters.Weight_1_2, *domain_parameters.AvP_1_2,
                                                                *sum_2_3, *domain_parameters.Weight_2_3, *domain_parameters.AvP_2_3,
                                                                *mu_2_12, *mu_1_12, *mu_2_23, *mu_3_23, *domain_parameters.ps2, *domain_parameters.ps1, *domain_parameters.ps3);
                    cathode_concentration_3->UpdateConcentration(*Rx_src_3, *CnC_gf_3, *domain_parameters.ps3, domain_parameters.gtPsi3, *domain_parameters.Weight_E_3, 
                                                                *sum_2_3, *domain_parameters.Weight_2_3, *domain_parameters.AvP_2_3,
                                                                *sum_3_1, *domain_parameters.Weight_3_1, *domain_parameters.AvP_3_1,
                                                                *mu_3_23, *mu_2_23, *mu_3_31, *mu_1_31, *domain_parameters.ps3, *domain_parameters.ps2, *domain_parameters.ps1);


                    *phC_gf = Constants::init_BvC;
                    *phE_gf = Constants::init_BvE;

                    reaction1->ExchangeCurrentDensity(*CnC_gf_1, *domain_parameters.AvP_E_1);
                    reaction2->ExchangeCurrentDensity(*CnC_gf_2, *domain_parameters.AvP_E_2);
                    reaction3->ExchangeCurrentDensity(*CnC_gf_3, *domain_parameters.AvP_E_3);

                    double globalerror_P = 1.0; // Error for particle potential
                    double globalerror_E = 1.0; // Error for electrolyte potential
            
                    // while ((globalerror_P > 1.0e-8 || globalerror_E > 1.0e-8)) {
                        // reaction->ButlerVolmer(*Rxn_gf, *CnC_gf, *CnE_gf, *phC_gf, *phE_gf, *domain_parameters.AvP_T);
                        reaction1->ButlerVolmer(*Rxn_gf_1, *CnC_gf_1, *CnE_gf, *phC_gf, *phE_gf, *domain_parameters.AvP_E_1);
                        reaction2->ButlerVolmer(*Rxn_gf_2, *CnC_gf_2, *CnE_gf, *phC_gf, *phE_gf, *domain_parameters.AvP_E_2);
                        reaction3->ButlerVolmer(*Rxn_gf_3, *CnC_gf_3, *CnE_gf, *phC_gf, *phE_gf, *domain_parameters.AvP_E_3);
                ...
                reaction1->TotalReactionCurrent(*Rxn_gf_1, global_current_1);
                reaction2->TotalReactionCurrent(*Rxn_gf_2, global_current_2);
                reaction3->TotalReactionCurrent(*Rxn_gf_3, global_current_3);
                ...
                Utils::SaveSimulationSnapshotMulti(t ,outdir, geometry, domain_parameters, *CnC_gf_1, *CnC_gf_2, *CnC_gf_3,
                    *C1_out, *C2_out, *C3_out, 1000);
